...
if __name__ == "__main__":
    ...
    for i in range(n_runs):
        ...
        print("T: ", _T)
        res = {'N': _N, 'T': _T}
        out = smc_hmc_int_snip(N=_N, T=_T, epsilon=0.1, ESSrmin=0.8, _y=y, _Z=Z, _scales=scales, verbose=True,
                               seed=int(seeds[i]))
    ...
    # Save data
    with open("results/aad_is_hmc_3e_atis08_ft/eps01_T250_N1000.pkl", "wb") as file:
